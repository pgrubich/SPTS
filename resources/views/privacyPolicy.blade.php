...
<div class="privacyPolicy">
    ...
    <hr>
    <div class="">
        <h2 class=""><strong>1. Informacje ogólne</strong></h2>
        <ol>
            <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>najlepszytrener.com.pl</b></li>
            <li>Operatorem serwisu oraz Administratorem danych osobowych jest: Pamela Grubich </li>

            <li>Adres kontaktowy poczty elektronicznej operatora: admin@najlepszytrener.com.pl</li>
            ...
            <ul><li>Prezentacja profilu użytkownika innym użytkownikom</li><li>Obsługa zapytań przez formularz</li><li>Prowadzenie systemu zapisów</li><li>Prowadzenie systemu komentarzy</li>
            </ul>
        ...
        <h2 class=""><strong>2. Wybrane metody ochrony danych stosowane przez Operatora</strong></h2>
        ...
        <h2 class=""><strong>3. Hosting</strong></h2>
        <ol>
            <li>Serwis jest hostowany (technicznie utrzymywany) na serwera operatora: linuxpl.com</li><li>Dane rejestrowe firmy hostingowej: H88 S.A. z siedzibą w Poznaniu, Franklina Roosevelta 22, 60-829 Poznań, wpisana do Krajowego Rejestru Sądowego przez Sąd Rejonowy Poznań – Nowe Miasto i Wilda w Poznaniu, Wydział VIII Gospodarczy Krajowego Rejestru Sądowego pod nr KRS 0000612359, REGON 364261632, NIP 7822622168, kapitał zakładowy 210.000,00 zł w pełni wpłacony.</li><li>Pod adresem <a href="https://linuxpl.com">https://linuxpl.com</a> możesz dowiedzieć się więcej o hostingu i sprawdzić politykę prywatności firmy hostingowej.</li><li>Firma hostingowa:<ul><li>stosuje środki ochrony przed utratą danych (np. macierze dyskowe, regularne kopie bezpieczeństwa),</li><li>stosuje adekwatne środki ochrony miejsc przetwarzania na wypadek pożaru (np. specjalne systemy gaśnicze),</li><li>stosuje adekwatne środki ochrony systemów przetwarzania na wypadek nagłej awarii zasilania (np. podwójne tory zasilania, agregaty, systemy podtrzymania napięcia UPS),</li><li>stosuje środki fizycznej ochrony dostępu do miejsc przetwarzania danych (np. kontrola dostępu, monitoring),</li><li>stosuje środki zapewnienia odpowiednich warunków środowiskowych dla serwerów jako elementów systemu przetwarzania danych (np. kontrola warunków środowiskowych, specjalistyczne systemy klimatyzacji),</li><li>stosuje rozwiązania organizacyjne dla zapewnienia możliwie wysokiego stopnia ochrony i poufności (szkolenia, wewnętrzne regulaminy, polityki haseł itp.),</li><li>powołała Inspektora Ochrony Danych.</li></ul></li>
        ...
        <h2 class=""><strong>4. Twoje prawa i dodatkowe informacje o sposobie wykorzystania danych</strong></h2>
        <ol><li>W niektórych sytuacjach Administrator ma prawo przekazywać Twoje dane osobowe innym odbiorcom, jeśli będzie to niezbędne do wykonania zawartej z Tobą umowy lub do zrealizowania obowiązków ciążących na Administratorze. Dotyczy to takich grup odbiorców:<ul><li>firma hostingowa na zasadzie powierzenia</li><li>upoważnieni pracownicy i współpracownicy, którzy korzystają z danych w celu realizacji celu działania strony</li></ul></li>
        ...
        <h2 class=""><strong>5. Informacje w formularzach</strong></h2>
        <ol>
            ...
            <li>Dane podane w formularzu są przetwarzane w celu wynikającym z funkcji konkretnego formularza. Każdorazowo kontekst i opis formularza w czytelny sposób informuje, do czego on służy.</li>
        </ol>


        <h2 class=""><strong>6. Informacja o plikach cookies</strong></h2>
        <ol>
        ...
        <h2 class=""><strong>7. Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</strong></h2>
        <ol>
